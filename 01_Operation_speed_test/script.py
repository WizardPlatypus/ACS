def find_do_over_one(bit_count, operation_count, repeat = 1):
    ...
    x = 1000
    n = pow(2, bit_count - 2)
    return repeat*n*x / (4*operation_count) * (1 + pow(1 + 8 * operation_count / repeat, 0.5))

operation_count = input("Operation count(20_000_000_000): ")
operation_count = 20_000_000_000 if operation_count == "" else int(operation_count)
